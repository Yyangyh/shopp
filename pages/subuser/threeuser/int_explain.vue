...
<script>
	...
	export default{
		...
		onShow() {
			this.service.entire(this,'post',this.service.api_root.subuser.threeuser.getCreditShopMsg,{},function(self,res){
				console.log(res)
				self.value = res.data.home_credit_shop_msg.value
			})
		}
	}
</script>
