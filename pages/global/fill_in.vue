<template>
	<view class="content">
				...
				<view class="date_content">
					<view class="box">
						...
						<view class="boxs">
							<text>更多</text>
							<text>日期</text>
							<text class="h2">￥100<text class="ll">起</text></text>
						</view>
					</view>
					<view class="title">
						<image src="../../static/icon/title.png" mode="widthFix"></image>请先选择使用日期
					</view>
				</view>
			</view>

			<view class="price">
				<text class="h3">成人票（可携带1名1.5米以下儿童入园）</text>
				<text class="h2">￥100</text>
			</view>
			<view class="num">
				<text>购买须知</text>
		...
		<view class="information">
			...
			<view class="log">
				<text>姓名</text>
				<input type="text" placeholder="须与证件上的名字一样" />
			</view>
			<view class="log">
				<text>手机</text>
		...
		<view class="offer">
			<view class="offer_name">
				<image src="../../static/icon/full.png" mode="widthFix"></image>
				<text>优惠券</text>
			</view>
			<view class="icon">
